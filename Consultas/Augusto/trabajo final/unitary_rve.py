...
displacement = gmsh.view.add("Desplazamientos")
...
gmsh.view.option.setNumber(displacement, "Visible", 0)
gmsh.view.option.setNumber(displacement, "GlyphLocation", 2)
gmsh.view.option.setNumber(displacement, 'VectorType', 5)
